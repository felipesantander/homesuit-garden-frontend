...
class GardensView extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    if (!authorizedComponents.contains('gardens_see')) {
      return const Center(child: Text('No tienes permiso para ver jardines'));
    }

    final canAdd = authorizedComponents.contains('gardens_add');
